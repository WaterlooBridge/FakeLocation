...
public class LuckyMoneyHook {
    ...
    private static final String receiveUIParamName = WECHAT_PACKAGE_NAME + ".am.o";
    ...
    private static final String openUIClass = WECHAT_PACKAGE_NAME + ".bt.d";//MicroMsg.PluginHelper
